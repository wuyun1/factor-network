(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.FactorNetwork = factory());
	...
	function createBackPropagation(settings) {
	  ...
	  var network$1 = create(options.network);
	  ...
	  function replaceNetwork(newNetwork) {
	    network$1 = newNetwork;
	  }

	  function compute$1(inputs) {
	    networkResult = compute(network$1, inputs, options.activation);
	    return networkResult;
	  }
	  ...
	  function computeError(labels) {
	    ...
	    return computeNetworkError(network$1, errors);
	  }
	  ...
	  function adjust(labels) {
	    ...
	    updateNetworkWeights(network$1, networkResult, networkError, options.activation, learningRate);
	  }
	...
	function updateNetworkWeights(network$1, networkResult, networkError, activationType, learningRate) {
	  walk$1(network$1, function (data) {
	    var path = data.path;
	    var currentWeight = network$1[path[0]][path[1]][path[2]];
	    ...
	    var currentActivation = getActivation$1(activationType, path[0]);
	    ...
	    network$1[path[0]][path[1]][path[2]] = newWeight;
	  });
	}
	...
	function mixNetwork(targetNetwork, sourceNetwork, mutation) {
	  walk$1(targetNetwork, function (data) {
	    var path = data.path;
	...
	var MCM = /*#__PURE__*/function () {
	  function MCM(board) {
	    _classCallCheck(this, MCM);
	...
	var MCTSNode = /*#__PURE__*/function () {
	...
	var UCT$1 = /*#__PURE__*/function () {
	  ...
	  _createClass(UCT, [{
	    ...
	    value: function run(iterations) {
	      var count = Number(iterations);
	      var root = new UCTNode$1(null, this.originalBoard.getActions(), null);
	...
	var UCTNode$1 = /*#__PURE__*/function () {
	  function UCTNode(action, nextActions) {
	    var parent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

	    _classCallCheck(this, UCTNode);
	...
	var MCNNS = /*#__PURE__*/function () {
	  function MCNNS(_ref) {
	    var network = _ref.network,
	        _ref$digitLength = _ref.digitLength,
	        digitLength = _ref$digitLength === void 0 ? 5 : _ref$digitLength,
	        activationType = _ref.activationType;

	    _classCallCheck(this, MCNNS);
	  ...
	  _createClass(MCNNS, [{
	    ...
	    value: function handleFeedback(resultList) {
	      ...
	      resultList.forEach(function (result, index) {
	        var _this2$collection$ind = _this2.collection[index],
	            node = _this2$collection$ind.node,
	            score = _this2$collection$ind.score;
	...
	var UCTNode = /*#__PURE__*/function () {
	  ...
	  _createClass(UCTNode, [{
	    ...
	    value: function getUCTValue() {
	      var averageReward = this.getScore();
	      var parameter = this.parent.getScore() * 4;
	      var bias = parameter * Math.sqrt(2 * Math.log(this.parent.visits) / this.visits);
	      return averageReward + bias;
	    }
	  }, {
	...
	var Board = /*#__PURE__*/function () {
	  function Board(_ref3) {
	    var network = _ref3.network,
	        ...
	        digitLength = _ref3$digitLength === void 0 ? 5 : _ref3$digitLength,
	        _ref3$weightIndex = _ref3.weightIndex,
	        weightIndex = _ref3$weightIndex === void 0 ? 0 : _ref3$weightIndex,
	        _ref3$digitIndex = _ref3.digitIndex,
	        digitIndex = _ref3$digitIndex === void 0 ? 0 : _ref3$digitIndex;
	...
	function computeNetwork(network, inputs) {
	  ...
	  for (var i = 0; i < network.length; i++) {
	    ...
	    for (var j = 0; j < currentLayer.length; j++) {
	      ...
	      for (var k = 0; k < currentNode.length; k++) {
	        var currentWeight = Number("0.".concat(currentNode[k].slice(0).join('')));
	        sum += currentInputs[k] * currentWeight;
	      }
...
//# sourceMappingURL=factor-network.js.map
